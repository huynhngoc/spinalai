...
input_dir = 'P:/SpinalAI/nifti'
output_dir = 'P:/SpinalAI/cropped_nifti_by_soft_tissue_window'
window_center = 400
window_width = 1800
...
for pid in os.listdir(input_dir):
    ...
    min_coords, size = crop_to_soft_tissue(image, window_center, window_width)
    ...
    roi_filter.SetSize(size[::-1].tolist())  # Reverse the order for SimpleITK
