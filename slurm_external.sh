...
singularity exec --nv deoxys.sif python -u test_experiment_external.py $1 $PROJECTS/ngoc/SpinalAI/perf/$2 --temp_folder $SCRATCH_PROJECTS/ceheads/SpinalAI/perf/$2 --analysis_folder $SCRATCH/analysis/$2 --epochs $3 ${@: 4}
